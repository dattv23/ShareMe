...
const PinDetail = ({ user }) => {
  ...
  return (
    <>
    <div className='flex xl-flex-row flex-col m-auto bg-whte' style={{ maxWidth: '1500px', borderRadius: '32px' }}>
      <div className='flex justify-center items-center md:items-start flex-initial'>
        <img src={pinDetail?.image && urlFor(pinDetail.image).url()} alt="user-port" className='rounded-t-3xl rounded-b-lg' />
      </div>
